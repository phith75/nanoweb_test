...
<div class="container">
    ...
    <form action="{{route('edit',['id'=> request()->route('id')])}}" method="POST">
        @csrf
        <div>
        ...
        <div>
            ...
            <input class="form-control" type="email" name="email" id="" value="{{$staff->email}}">
        </div>
        <div>
            <label for="">Tel</label>
            <input class="form-control" type="text" name="tel" id="" value="{{$staff->tel}}">
        </div>
